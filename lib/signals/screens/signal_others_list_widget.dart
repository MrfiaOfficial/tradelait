...
class SignalListOthers extends StatefulWidget {
  @override
  State<SignalListOthers> createState() => _SignalListOthersState();
}

class _SignalListOthersState extends State<SignalListOthers> {
  ...
  Stream<QuerySnapshot> signalsList = FirebaseFirestore.instance
      .collection('signals')
      .where('signalType', isEqualTo: 'Others')
      .snapshots();
