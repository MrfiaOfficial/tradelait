...
class Palette {
  ...
  static final Color firebaseNavy = Color(0xFFaf1b56);
  static final Color firebaseOrange = Color(0xFFf399bd);
  static final Color firebaseAmber = Color(0xFFf399bd);
  static final Color firebaseYellow = Color(0xFFFFDCEA);
  static final Color firebaseGrey = Color(0xFFECEFF1);
  static final Color googleBackground = Color(0xFF4285F4);
  static final Color firebaseWhite = Color(0xFFFFFFFF);
}
