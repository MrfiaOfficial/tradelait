...
class AssetAddForm extends StatefulWidget {
  ...
  @override
  _AssetAddFormState createState() => _AssetAddFormState();
}

class _AssetAddFormState extends State<AssetAddForm> {
  ...
  final TextEditingController _valuePurchasedController =
      TextEditingController();
  final TextEditingController _valuePresentController = TextEditingController();
  final TextEditingController _valueOneYearController = TextEditingController();
  final TextEditingController _valueFiveYearsController =
      TextEditingController();
  final TextEditingController _valueTenYearsController =
      TextEditingController();
  final TextEditingController _purchasedDateController =
      TextEditingController();
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_addItemFormKey.currentState!.validate()) {
                          ...
                          await AssetService(uid: currentUser!.uid).addAsset(
                            assetUid: '',
